        ...
        <div className='flex w-full min-w-[300px]  border border-primary-purple rounded-md shadow-md justify-between p-2 '>
            ...
            <div className="flex flex-col gap-2 items-end w-fit">
                ...
                <Link to={`${name.split(' ').join(('-'))}`}>
                    <p className='border border-primary-purple rounded-md w-fit p-1 px-2 hover:cursor-pointer hover:text-white hover:bg-accent-purple hover:font-bold text-center text-sm text-nowrap '>View Profile</p>
                </Link>
            </div>
        </div>
    )
