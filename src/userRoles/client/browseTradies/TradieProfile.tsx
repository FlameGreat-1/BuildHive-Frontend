                ...
                <div className="w-full md:w-1/2 gap-4">
                    ...
                    <div className="flex-col  p-2 gap-4 hidden md:flex">
                        <div className="flex justify-between shadow-md p-2 items-center border rouned-md">
                            <p className=" flex items-center gap-1"><p className="rounded-sm border font-bold border-primary-purple p-2">$</p> Hourly Rate</p>
                            <p className="font-semibold">$80.00</p>
                        </div>
                        <div className="shadow-sm rounded-[30px] flex border-slate-500 border py-2 px-4 font-semibold justify-between items-center w-fit gap-4">
                            ...
                            currentSection === 'about' && (
                                <div className="flex flex-col gap-4 p-2">
                                    <div className="relative">
                                        <p className={` ${showMore ? 'overflow-y-scroll' : 'line-clamp-[7] lg:line-clamp-[5]'} max-h-[250px]   `}>
                                    ...
                                    <div className="flex-col flex p-2 gap-4">
                                        <div className="flex justify-between shadow-md p-2 items-center border rouned-md">
                                            <p className=" flex items-center gap-1"><p className="rounded-sm border font-bold border-primary-purple p-2">$</p> Hourly Rate</p>
                                            <p className="font-semibold">$80.00</p>
                                        </div>
