    ...
    return (
        <div className="p-4 flex flex-col gap-3 w-full max-w-[300px] md:max-w-[280px] shadow-md rounded-md border " >
            ...
            <div className="flex gap-4">
                <p className={`${invoiced ? 'text-white bg-primary-purple' : 'bg-gray-300'} border w-fit p-1 px-2 rounded-[20px] text-sm md:text-md `}>Invoiced</p>
                <p className={`${materialsOrdered ? 'text-white bg-primary-purple' : 'bg-gray-300'} border w-fit p-1 px-2 rounded-[20px] text-sm md:text-md `}>Materials Ordered</p>
            </div>
