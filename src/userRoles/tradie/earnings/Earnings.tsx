  ...
  return (
    <div className="p-4 w-full flex flex-col gap-6">
      ...
      <div className="grid grid-cols-2 md:grid-cols-3 gap-4 text-center">
        <div className='shadow-md rounded-2xl p-4 border'>
      ...
      <div className="flex flex-col items-center">
        <p className="text-sm text-gray-600 mb-2">Pending <span className='w-2 h-2  bg-gray-300 inline-block'></span> | Paid <span className='w-2 h-2 bg-[#6366f1] inline-block'></span></p>
        ...
        type='button' 
        className="mt-4 bg-indigo-600 text-white px-4 py-2 rounded-md text-sm hover:bg-indigo-700 transition">
          Withdraw Funds
        </button>
      </div>
