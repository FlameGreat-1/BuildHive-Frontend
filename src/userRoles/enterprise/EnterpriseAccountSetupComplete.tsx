...
import bgImage from '@/assets/images/enterpriseAccountSetupImage.webp'


const EnterpriseAccountSetupComplete = () => {
    return (
        <motion.div
            key="step3"
            ...
            <div className=" w-full p-4 glassmorphic flex-center rounded-[20px] max-w-[90%] sm:max-w-[400px]">
                <div className=" w-full max-w-[400px] flex-center flex-col gap-4 p-4">
                    <div className="flex-center flex-col gap-4 text-center ">
                        <p className=" text-xl sm:text-2xl md:text-3">Welcome to Build Hive Enterprise!</p>
                        <p className="text-base md:text-lg">Start posting jobs, assigning tasks and tracking team progress in one place.</p>
                    </div>
...
export default EnterpriseAccountSetupComplete