  ...
  return (
    ...
    >
      ...
      <img
        src={image}
        alt="You did it!"
        className='min-w-[clamp(200px,100%,400px]'
      />
      <PurpleBtn text='Set Up My Account' classes='w-full text-center max-w-[300px]' upperCase='false' click={() => navigate(`/app/${role}/account-setup`)} />
    </motion.div>
  )
}
