...
const CtaComp = () => {
    return (
        ...
        '>
            <div className="max-w-6xl gap-4 flex md:items-start justify- items-center flex-col ">
                <div className="flex items-center md:items-start justify-center flex-col w-full sm:w-1/2  text-center md:text-left">
                    ...
                    <div className='font-bold text-lg md:text-xl text-black'>
                        Ready to <span className="text-purple-bg">build smarter</span> and work faster?
                    </div>
