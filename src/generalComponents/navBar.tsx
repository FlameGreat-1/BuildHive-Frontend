...
const NavBar = () => {
    ...
    return (
        <div className="w-full flex-btw px-8 py-2 my-2  sm:bg-light-white mx-8 rounded-[20px] relative lg:gap-[20%] ">
            <Link to={'/'}>
                <img src={buildHiveIcon} alt="BuildHive" className="w-[4rem]" />
            </Link>
            {/* SECTION FOR NAVBAR LINKS */}
            <div className="w-full">
                <div className={` ${showMenu ? 'flex ' : 'hidden'} ," flex-even w-full md:flex  flex-col md:flex-row absolute top-[4rem] left-0 right-0  md:static "`}>
                    <div className="bg-light-white md:bg-transparent md:flex-row w-full py-8 sm:py-0 rounded-b-md flex-col flex-center sm:justify-between">
                        ...
                        <PurpleBtn text={"Get Started"} classes="w-fit" />
                    </div>
